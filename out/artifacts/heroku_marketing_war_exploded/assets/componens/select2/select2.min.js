        ...
        i = a(document), f = function () {
            ...
            bind: function (a) {
                ...
                if (e ? (c.query = this.bind(function (a) {
                        ...
                        return a.id
                    }) : "query"in c || ("ajax"in c ? (h = c.element.data("ajax-url"), h && h.length > 0 && (c.ajax.url = h), c.query = G.call(c.element, c.ajax)) : "data"in c ? c.query = H(c.data) : "tags"in c && (c.query = j(c.tags), c.createSearchChoice === b && (c.createSearchChoice = function (b) {
                        ...
                        callback: this.bind(function (g) {
                            ...
                            if (l == this.queryCount) {
                                ...
                                if (this.context = g.context === b ? null : g.context, this.opts.createSearchChoice && "" !== d.val() && (i = this.opts.createSearchChoice.call(h, d.val(), g.results), i !== b && null !== i && h.id(i) !== b && null !== h.id(i) && 0 === a(g.results).filter(function () {
                                    ...
                                    }).length && this.opts.createSearchChoicePosition(g.results, i)), 0 === g.results.length && J(f.formatNoMatches, "formatNoMatches"))return n("<li class='select2-no-results'>" + K(f.formatNoMatches, f.element, d.val()) + "</li>"), this.showSearch && this.showSearch(d.val()), void 0;
