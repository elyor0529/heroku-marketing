...
!function (a) {
    ...
    var m = a.fn.datepicker, n = function (c) {
        ...
        return this.each(function () {
            var f = a(this), g = f.data("datepicker"), j = "object" == typeof c && c;
            if (!g) {
                var m = h(this, "date"), n = a.extend({}, o, m, j), p = i(n.language), q = a.extend({}, o, p, m, j);
                if (f.hasClass("input-daterange") || q.inputs) {
                    var r = {inputs: q.inputs || f.find("input").toArray()};
                    f.data("datepicker", g = new l(this, a.extend(q, r)))
                } else f.data("datepicker", g = new k(this, q))
            }
